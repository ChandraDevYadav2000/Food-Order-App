...
function Checkout() {
  ...
  return (
    <div>
        ...
        <div className='p-5 px-5 md:px-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
            ...
            <div className='mx-10 border'>
                ...
                <div className='p-4 flex flex-col gap-4'>
                    ...
                    <hr />
                    <h2 className='flex justify-between'>Delivery : <span>Rs {deliveryAmount}</span></h2>
                    <h2 className='flex justify-between'>Tax (9%) : <span>Rs{taxAmount.toFixed(2)}</span></h2>
                    <hr />
                    <h2 className='font-bold flex justify-between'>Total : <span>Rs {total.toFixed(2)}</span></h2>
                    {/* <Button onClick={()=>onApprove({paymentId:123})}>Payment <ArrowBigRight/></Button> */}
                    {/* <Button onClick={()=>addToOrder()}>{loading?<Loader className='animate-spin'/>:'Make Payment'}</Button> */}
                    {total>5&&  <PayPalButtons style={{ layout: "vertical" }}
