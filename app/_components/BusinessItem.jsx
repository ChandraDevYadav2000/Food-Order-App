...
function BusinessItem({business}) {
  ...
  return (
    <Link href={'/restaurant/'+business?.slug} className='p-3 hover:border rounded-xl hover:border-primary cursor-pointer hover:bg-orange-100'>
        <Image src={business.banner?.url} alt={business.name} width={500} height={200}
